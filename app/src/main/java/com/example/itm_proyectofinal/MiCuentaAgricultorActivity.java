...
public class MiCuentaAgricultorActivity extends AppCompatActivity {
    int codAgri;
    TextView date,etDni,etNombre,etApellido,celular,direccion,correo,tipo,depar,prov,fech_reg,regresar;
    Button editar;
    ImageView home,icon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i= new Intent(getApplicationContext(),EditarCuentaAgricultorActivity.class);
                i.putExtra("idAgricultor",codAgri);
                startActivity(i);
            }
        });
