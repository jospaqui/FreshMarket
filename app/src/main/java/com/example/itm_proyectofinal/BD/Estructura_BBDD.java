...
public class Estructura_BBDD {
    ...
    public static final String SQL_CREATE_USER_AGRICULTOR="CREATE TABLE USUARIO_AGRICULTOR (" +
            ...
            "departamento_agri VARCHAR(50) NOT NULL,"+
            "provincia_agri VARCHAR(50) NOT NULL,"+
    ...
    public static final String SQL_CREATE_COMENTARIO="CREATE TABLE COMENTARIO (" +
            ...
            "id_us_clasic INTEGER REFERENCES USUARIO_CLASICO(id_us_cla)," +
    ...
    public static final String SQL_CREATE_VENTA="CREATE TABLE VENTA (" +
            ...
            "id_agricultor INTEGER REFERENCES USUARIO_AGRICULTOR(id_us_agri)," +
            "id_clasico INTEGER REFERENCES USUARIO_CLASICO(id_us_cla)," +
            "costo_delivery NUMERIC NOT NULL," +
            "monto_total NUMERIC NOT NULL,"+
            "departamento_entrega VARCHAR(50) NOT NULL,"+
            "provincia_entrega VARCHAR(50) NOT NULL,"+
    ...
    public static final String SQL_CREATE_VENTA_DETALLE="CREATE TABLE VENTA_DETALLE (" +
            "id_v INTEGER REFERENCES VENTA(id_venta)," +
            "id_prodc INTEGER REFERENCES PRODUCTO(id_prod)," +
            "cantidad INTEGER NOT NULL," +
            "precio_cant_prodc NUMERIC NOT NULL,"+
            "PRIMARY KEY(id_v,id_prodc))";

    public static final String SQL_DELETE_VENTA_DETALLE ="DROP TABLE IF EXISTS VENTA_DETALLE";

    public static final String SQL_CREATE_PRUEBA_PEDIDO="CREATE TABLE PEDIDO_PRUEBA (" +
            "id_pedido INTEGER PRIMARY KEY AUTOINCREMENT," +
            "id_producto_pe INTEGER NOT NULL," +
            "id_agricul_pe INTEGER NOT NULL," +
            "id_clasico_pe INTEGER NOT NULL," +
            "cantidad_pe INTEGER NOT NULL," +
            "precio_parcial_pe NUMERIC NOT NULL)";
    public static final String SQL_DELETE_PRUEBA_PEDIDO="DROP TABLE IF EXISTS PEDIDO_PRUEBA";
}
